  ...
  return (
    <>
      <div className='flex flex-wrap justify-center items-center my-0 mx-auto box-border shadow min-w-96 overflow-hidden w-screen min-h-[80vh]'>
        <header className='flex items-center justify-center bg-morado-500 p-6 w-full h-28'>
          <a href='/' className="logo bg-morado-700 rounded-xl h-9/12 py-2.5 px-5">
            <h1>Zapateria La 0800</h1>
          </a>
        </header>
        <main className='mx-auto justify-center items-center bg-morado-900 w-full h-full p-12'>
          <div>
        ...
        <footer className='flex justify-center items-center w-full p-6 bg-morado-500'>
